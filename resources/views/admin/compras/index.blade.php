        ...
        <div class="card card-outline card-primary">
            ...
            <div class="card-body table-responsive" style="display: block;">
                <table id="example1" class="table table-bordered table-striped table-hover table-sm">
                    ...
                    <tbody>
                        @foreach ($compras as $compra) <!-- Esta variable viene del controller -->
                            <tr>
                                <td style="text-align: center">{{ $loop->iteration }}</td> <!-- Muestra un contador en lugar del ID real -->
                                <td>{{ $compra->proveedor->nombre }}</td> <!-- Muestra el nombre de la categoría relacionada porque es la fk en vez del id -->
                                <td>{{ $compra->fecha }}</td>
                                <td>{{ $compra->total }}</td>   
                                <td>{{ $compra->estado }}</td>
