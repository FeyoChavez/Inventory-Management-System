    ...
    'menu' => [
        ...
        ['header' => 'Menú'],
         ...
         [
            ...
            'active' => ['admin/sucursales*'], // Marca en azul el item seleccionado del menu
        ],
        ...
        [
            ...
            'classes' => 'bg-blue text-white',
            'active' => ['admin/categoria*'], // Marca en azul el item seleccionado del menu
        ],
        ...
        [
            ...
            'classes' => 'bg-blue text-white',
            'active' => ['admin/producto*'], // Marca en azul el item seleccionado del menu
        ],
        ...
        [
            ...
            'classes' => 'bg-blue text-white',
            'active' => ['admin/proveedor*'], // Marca en azul el item seleccionado del menu
        ],
        ...
        [
            ...
            'classes' => 'bg-blue text-white',
            'active' => ['admin/compra*'], // Marca en azul el item seleccionado
        ],
        ...
        [
            ...
            'classes' => 'bg-blue text-white',
            'active' => ['admin/inventario*'], // Marca en azul el item seleccionado
            'submenu' => [
                [
                    'text' => 'Lotes',
                    'url' => 'admin/lotes',
